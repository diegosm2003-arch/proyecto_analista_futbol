...
ROLE_FEATURES: tuple[Feature, ...] = (
    ...
    Feature("cross_rate", "crosses_into_penalty_area", "passes_attempted", "Centros por pase"),
    ...
    Feature(
        "carry_progression", "carries_into_final_third", "carries", "Conducciones al ultimo tercio"
    ),
...
ARCHETYPES: dict[str, tuple[Archetype, ...]] = {
    "DF": (
        ...
        Archetype(
            ...
            {
                "progressive_pass_rate": 1.5,
                "final_third_pass_rate": 1.0,
                "touch_share_mid": 1.0,
                "carry_progression": 0.8,
                "aerial_rate": -0.3,
            },
    ...
    "FW": (
        ...
        Archetype(
            "Extremo de banda",
            {"cross_rate": 1.5, "take_on_rate": 1.3, "touch_share_att": 1.0, "shot_rate": -0.5},
            "Ataca por fuera, encara y centra.",
        ),
        Archetype(
            "Extremo finalizador",
            {"shot_rate": 1.3, "box_presence": 1.2, "take_on_rate": 1.0, "cross_rate": -0.9},
